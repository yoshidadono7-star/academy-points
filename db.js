...
const DAILY_MISSION_POOL = [
  // Common (50%)
  { id: 'dm_pomo2', name: 'ポモドーロ修練', desc: 'ポモドーロを2回完走', rarity: 'common', points: 15, icon: '🍅',
    quest: '集中の炎を2度灯せ。修練の基本を忘れるな。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.totalPomodoros >= 2 },
  { id: 'dm_30min', name: '偵察任務', desc: '今日の合計で30分以上学習', rarity: 'common', points: 10, icon: '⏱️',
    quest: '30分の偵察航海に出よ。何回かに分けてもOK！小さな発見が大きな力になる。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.totalMinutes >= 30 },
  { id: 'dm_condition', name: '状態報告', desc: 'コンディションを記録', rarity: 'common', points: 5, icon: '😊',
    quest: '本日のクルー状態を管制塔に報告せよ。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.conditionRecorded },
  { id: 'dm_task1', name: '作戦遂行', desc: 'タスクを1つ完了', rarity: 'common', points: 10, icon: '✅',
    quest: '指令されたタスクを1つ完了せよ。確実な任務遂行が信頼を築く。',
  ...
  { id: 'dm_review', name: '航海日誌', desc: '学習を振り返って記録', rarity: 'common', points: 10, icon: '📝',
    quest: '今日の航海を振り返り、日誌に記録せよ。過去を省みる者が未来を拓く。',
    checkType: 'manual', conditionFn: null },
  { id: 'dm_preview', name: '先行調査', desc: '翌日の授業科目を予習', rarity: 'common', points: 10, icon: '📖',
    quest: '明日の航路を先行調査せよ。備えあれば憂いなし。',
    checkType: 'manual', conditionFn: null },
  // Uncommon (30%)
  { id: 'dm_weak20', name: '弱点克服訓練', desc: '苦手科目を20分以上', rarity: 'uncommon', points: 25, icon: '💪',
    quest: '苦手領域に20分潜入せよ。克服した者だけが次の星域に進める。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.weakSubjectMinutes >= 20 },
  { id: 'dm_pomo3', name: '集中修行・参式', desc: 'ポモドーロ3回連続完走', rarity: 'uncommon', points: 30, icon: '🍅',
    quest: '集中の炎を3度連続で灯せ。真の集中力を見せよ。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.totalPomodoros >= 3 },
  { id: 'dm_2subj', name: '二刀流の探求', desc: '2教科以上学習', rarity: 'uncommon', points: 20, icon: '📚',
    quest: '2つの学問を渡り歩け。多才なるクルーこそ艦隊の要。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.subjectCount >= 2 },
  { id: 'dm_60min', name: '長距離航海', desc: '今日の合計で60分以上学習', rarity: 'uncommon', points: 30, icon: '⏱️',
    quest: '合計60分の長距離航海に出よ。何回かに分けてもOK！忍耐が星間飛行の鍵だ。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.totalMinutes >= 60 },
  { id: 'dm_home', name: '基地外活動', desc: '自宅から学習セッション完了', rarity: 'uncommon', points: 20, icon: '🏠',
    quest: '母星（自宅）から遠隔作戦を実行せよ。どこでも学べる者は強い。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.homeStudied },
  // Rare (15%)
  { id: 'dm_3subj', name: 'トリプルダイブ', desc: '3教科以上学習', rarity: 'rare', points: 50, icon: '🌟',
    quest: '3つの星域に同時潜入せよ。マルチタレントの証を手に入れろ。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.subjectCount >= 3 },
  { id: 'dm_morning', name: '夜明けの剣', desc: '12時前に学習開始', rarity: 'rare', points: 40, icon: '🌅',
    quest: '太陽が頂点に達する前に剣を抜け。朝の1時間は夜の3時間に匹敵する。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.earliestHour < 12 },
  { id: 'dm_pomo5', name: '集中修行・伍式', desc: 'ポモドーロ5回完走', rarity: 'rare', points: 60, icon: '🍅',
    quest: '集中の炎を5度灯せ。この修行を超えた者は「ポモドーロの達人」と呼ばれる。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.totalPomodoros >= 5 },
  { id: 'dm_boss_weak', name: 'ボスの急所', desc: 'ボスの弱点科目を45分', rarity: 'rare', points: 55, icon: '🎯',
    quest: 'レイドボスの弱点を45分間集中攻撃せよ。クリティカルヒットを狙え！',
    checkType: 'auto_daily', conditionFn: (ds) => ds.bossWeaknessMinutes >= 45 },
  // Epic (4%)
  { id: 'dm_5day_clear', name: '不屈の連鎖', desc: 'ミッション5日連続達成', rarity: 'epic', points: 100, icon: '🔥',
    quest: '5日間途切れることなくミッションを達成し続けよ。不屈の意志を証明せよ。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.missionStreak >= 5 },
  { id: 'dm_perfect', name: '完全なる一日', desc: '全活動を完了', rarity: 'epic', points: 80, icon: '💎',
    quest: 'コンディション記録、30分学習、タスク完了——全てを1日でこなせ。完璧な日を作れ。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.conditionRecorded && ds.totalMinutes >= 30 && ds.tasksCompleted >= 1 },
  // Legendary (1%)
  { id: 'dm_weekly_king', name: '星海の覇王', desc: '週6日以上出席', rarity: 'legendary', points: 200, icon: '👑',
    quest: '週6日以上の出席を記録せよ。この偉業を成し遂げた者のみが覇王の称号を得る。',
    checkType: 'auto_daily', conditionFn: (ds) => ds.weeklyAttendance >= 6 },
  { id: 'dm_hidden1', name: '???', desc: '???', rarity: 'legendary', points: 150, icon: '🌌',
    quest: '？？？', hidden: true,
    checkType: 'auto_daily', conditionFn: (ds) => ds.totalPomodoros >= 7 && ds.subjectCount >= 4 },
];
