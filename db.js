...
const DAILY_MISSION_POOL = [
  ...
  { id: 'dm_30min', name: '偵察任務', desc: '合計30分以上学習', rarity: 'common', points: 10, icon: '⏱️',
    quest: '30分の偵察航海に出よ。小さな発見が大きな力になる。',
  ...
  { id: 'dm_60min', name: '長距離航海', desc: '60分以上学習', rarity: 'uncommon', points: 30, icon: '⏱️',
    quest: '60分の長距離航海に耐えよ。忍耐が星間飛行の鍵だ。',
